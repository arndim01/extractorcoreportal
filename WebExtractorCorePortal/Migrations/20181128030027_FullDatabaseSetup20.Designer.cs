...
namespace WebExtractorCorePortal.Migrations
{
    ...
    [Migration("20181128030027_FullDatabaseSetup20")]
    partial class FullDatabaseSetup20
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebExtractorCorePortal.Models.AmendmentLoaded", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<bool>("CommodityLoaded");

                    b.HasKey("Id");

                    b.HasIndex("AmendmentRefId");

                    b.ToTable("TAmendmentLoadeds");
                });
            ...
            modelBuilder.Entity("WebExtractorCorePortal.Models.LibCityDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WebExtractorCorePortal.Models.Rate", b =>
                {
                    ...
                    b.Property<string>("CommodityHash")
                        .HasMaxLength(128);

                    b.Property<string>("DestinationValue")
                        .HasMaxLength(128);

                    b.Property<string>("DestinationViaValue")
                        .HasMaxLength(128);
                    ...
                    b.Property<string>("OriginViaValue")
                        .HasMaxLength(128);
            ...
            modelBuilder.Entity("WebExtractorCorePortal.Models.RateBullet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WebExtractorCorePortal.Models.RateNoteIndexed", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("NumberNotes");

                    b.Property<string>("RateNoteType")
                        .IsRequired();
