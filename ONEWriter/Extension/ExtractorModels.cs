...
namespace ONEWriter.Extension
{
    ...
    public class Rate
    {
        ...
        public long? CommodityRefId { get; set; }
        [ForeignKey("CommodityRefId")]
        public virtual RateCommodity Commodity { get; set; }
        ...
        [ForeignKey("HazRef")]
        public virtual ICollection<RateHazGen> Hazardous { get; set; }

        [ForeignKey("BRRefId")]
        public virtual ICollection<RateBR> BaseRates { get; set; }

        [ForeignKey("RateLineNoteRefId")]
        public virtual ICollection<RateLineNote> RateLineNotes { get; set; }

        [ForeignKey("RateGeneralNoteRefId")]
        public virtual ICollection<RateGeneralNote> RateGeneralNotes { get; set; }

        [ForeignKey("FreetimeId")]
        public virtual ICollection<RateFreetimeDirect> RateFreetimeDirects { get; set; }
